...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEditagent = new QLineEdit(tabprojectInsert);
        lineEditagent->setObjectName(QString::fromUtf8("lineEditagent"));

        formLayout->setWidget(6, QFormLayout::FieldRole, lineEditagent);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_7->setText(QCoreApplication::translate("MainWindow", "Agent", nullptr));
